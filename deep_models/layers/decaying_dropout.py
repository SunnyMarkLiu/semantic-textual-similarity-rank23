...
class DecayingDropout(Layer):
    def __init__(self,
        ...
        :param initial_keep_rate: Initial keep rate of decaying dropout, default 1.0
        :param decay_interval: Dropout decay interval, every `x` step decay dropout rate.
        :param decay_rate: Decay rate of dropout
        :param noise_shape:
        :param seed:
        :param kwargs:
        """
