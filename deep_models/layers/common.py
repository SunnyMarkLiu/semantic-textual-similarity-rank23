...
def gated_liner_bn_units(input1, input2, filters, kernel_size, padding, activation):
    """
    Ref: Language Modeling with Gated Convolutional Networks
    ...
    conv1 = Activation(activation=activation)(BatchNormalization()(conv_layer(input1)))
    gate2 = gate_layer(input2)
    ...
    conv2 = Activation(activation=activation)(BatchNormalization()(conv_layer(input2)))
    gate1 = gate_layer(input1)
